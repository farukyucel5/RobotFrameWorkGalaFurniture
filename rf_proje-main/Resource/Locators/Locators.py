...
HomeLocator = "(//div[@class='header-menu__summary-container'])[6]"
...
urunlerLinkleriLocator = "//a[@class='product-card__link absolute inset-0 z-10']"
listeLocator = "//li[@class='collection__grid-item']"
#ürün detay
urunBasligi = "//h1"
